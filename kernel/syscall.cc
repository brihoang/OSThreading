    ...
    case 13: /* execv */
        {
			 ...
			 long *sysCallArgs = (long*) a0; 
             char* name = (char*) sysCallArgs[0];
             char** userArgs = (char**)sysCallArgs[1];
			 int numUserArgs = (int)sysCallArgs[2];
             ...
             long rc = Process::current->execv(name,&args,numUserArgs);
